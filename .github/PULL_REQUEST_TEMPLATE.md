...
See [CONTRIBUTING.md](https://github.com/273v/kaos-llm-client/blob/main/CONTRIBUTING.md)
...
- [ ] `uv run ruff format --check kaos_llm_client/ tests/` passes
- [ ] `uv run ruff check kaos_llm_client/ tests/` passes
- [ ] `uv run ty check kaos_llm_client/ tests/` passes
