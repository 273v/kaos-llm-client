...
This document defines how `kaos-llm-client` handles features, bugs,
...
- What `kaos-llm-client` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_llm_client`.
