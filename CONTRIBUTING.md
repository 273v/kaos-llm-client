...
`kaos-llm-client` requires Python 3.13 or newer. It publishes the `kaos_llm_client`
import package. This package publishes CLI entry point(s): `kaos-llm-client`, `kaos-llm-serve`.
Public extras currently declared: `azure`.
...
include the `kaos-llm-client` version, Python version, operating system,
